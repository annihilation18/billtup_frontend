...
import { ChevronDown, ChevronUp, Home, FileText, CreditCard, Users, Settings, ArrowRight } from "lucide-react";
...
function IPhoneFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="mx-auto my-6">
      {/* iPhone Frame */}
      <div className="relative mx-auto" style={{ width: "410px", height: "884px" }}>
        {/* Outer Frame */}
...
const guideSections: GuideSection[] = [
    ...
    steps: [
      {
        ...
        description: "Your journey to effortless invoicing starts here",
      ...
      },
      {
        ...
        description: "Add your business information for professional invoices",
    ...
    steps: [
      {
        ...
        description: "Your central hub for managing invoices and business",
    ...
    steps: [
      {
        ...
        description: "Build professional invoices in under 2 minutes",
      ...
      },
      {
        ...
        description: "Access complete invoice information and actions",
  ...
  },
  {
    ...
    steps: [
      {
        title: "App Settings",
        description: "Configure your business information and payment settings",
      ...
      <div className="bg-white/10 backdrop-blur-sm border-b border-white/20 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-white text-3xl">BilltUp Visual User Guide</h1>
              <p className="text-white/70">Step-by-step instructions with iPhone mockups</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <Card className="mb-8 bg-white/95 backdrop-blur-sm border-white/20">
          ...
          <CardContent className="space-y-4">
            <p className="text-lg">
              This visual guide walks you through every feature of BilltUp using actual iPhone screen mockups.
              Each section shows you exactly what you'll see on your device.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="p-4 bg-gradient-to-br from-[#1E3A8A]/10 to-[#1E3A8A]/5 rounded-lg border border-[#1E3A8A]/20">
                ...
                <h3 className="text-foreground mb-2">Create Invoices</h3>
                <p className="text-sm text-muted-foreground">
                  Professional PDF invoices with your business branding
                </p>
              </div>
              ...
              <div className="p-4 bg-gradient-to-br from-[#14B8A6]/10 to-[#14B8A6]/5 rounded-lg border border-[#14B8A6]/20">
                ...
                <h3 className="text-foreground mb-2">Accept Payments</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="p-4 bg-gradient-to-br from-[#F59E0B]/10 to-[#F59E0B]/5 rounded-lg border border-[#F59E0B]/20">
                ...
                <h3 className="text-foreground mb-2">Manage Customers</h3>
                <p className="text-sm text-muted-foreground">
                  Track customer info and complete invoice history
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              <p className="text-sm text-blue-900 dark:text-blue-100">
                <strong>💡 How to use this guide:</strong> Click on any section below to expand it and see detailed 
                step-by-step instructions with iPhone mockups showing exactly what you'll see in the app.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-6">
          {guideSections.map((section, sectionIndex) => (
            <Card key={section.id} className="bg-white/95 backdrop-blur-sm border-white/20 overflow-hidden">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        {section.steps.length} step{section.steps.length > 1 ? 's' : ''} with iPhone mockups
                      </p>
                    </div>
                  </div>
              ...
              {expandedSection === section.id && (
                <CardContent className="pt-8">
                  {section.steps.map((step, stepIndex) => (
                    <div key={stepIndex}>
                      {stepIndex > 0 && <Separator className="my-12" />}
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <h3 className="text-foreground text-2xl mb-2">{step.title}</h3>
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
                          <div className="flex items-center gap-2 mb-4">
                            ...
                            <h4 className="text-foreground">What You'll See & Do:</h4>
                          </div>
                        ...
                        {step.tips && step.tips.length > 0 && (
                          <div className="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-950/20 dark:to-yellow-950/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-4">
                              ...
                              <h4 className="text-foreground">Pro Tips</h4>
                            </div>
                            <ul className="space-y-2">
                              {step.tips.map((tip, tipIndex) => (
                                <li key={tipIndex} className="flex items-start gap-3 text-amber-900 dark:text-amber-100">
        ...
        <Card className="mt-8 bg-white/95 backdrop-blur-sm border-white/20">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="text-foreground mb-3">Transaction Fees</h4>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Platform fee: 0.6% + $0.20</li>
                  <li>• Stripe processing: 2.9% + $0.30</li>
                  <li>• <strong className="text-foreground">Total: 3.5% + $0.50 per transaction</strong></li>
                  <li>• Example: $100 invoice = $3.50 fee, you receive $96.50</li>
                </ul>
              </div>

              <div>
                <h4 className="text-foreground mb-3">Security Features</h4>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Bank-level encryption for all data</li>
                  <li>• PCI DSS compliant payment processing</li>
                  <li>• Payment info processed by Stripe only</li>
        ...
        <div className="text-center mt-12 pb-8">
          <p className="text-white/70 text-lg mb-2">Need more help?</p>
          <p className="text-white/50 mb-6">Check the /docs folder for technical documentation</p>
          ...
          <p className="text-white/50 mt-8">BilltUp v1.0.0 • © 2025 BilltUp. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
