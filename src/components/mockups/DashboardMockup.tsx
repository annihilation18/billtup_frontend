...
import { Search, Plus, FileText, Users, Settings, Calendar, TrendingUp, DollarSign, Clock, CheckCircle2 } from "lucide-react";
        ...
        <div className="grid grid-cols-2 gap-2 mb-3">
          ...
          <Card className="p-3 bg-gradient-to-br from-[#1E3A8A]/10 to-[#1E3A8A]/5 border-[#1E3A8A]/20">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-[10px] text-muted-foreground">November Sales</p>
            </div>
            <p className="text-lg font-mono text-[#1E3A8A]">$5,432.50</p>
          </Card>
          ...
          <Card className="p-3 bg-gradient-to-br from-[#14B8A6]/10 to-[#14B8A6]/5 border-[#14B8A6]/20">
            ...
            <p className="text-lg font-mono text-[#14B8A6]">$42,890.75</p>
          </Card>
          ...
          <Card className="p-3 bg-gradient-to-br from-[#F59E0B]/10 to-[#F59E0B]/5 border-[#F59E0B]/20">
            ...
            <p className="text-lg font-mono text-[#F59E0B]">$1,250.00</p>
          </Card>
          ...
          <Card className="p-3 bg-gradient-to-br from-[#8B5CF6]/10 to-[#8B5CF6]/5 border-[#8B5CF6]/20">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-[10px] text-muted-foreground">Invoices This Cycle</p>
            </div>
            <p className="text-lg font-mono text-[#8B5CF6]">12</p>
            <p className="text-[9px] text-muted-foreground mt-0.5">15 days left</p>
          </Card>
        </div>
        ...
        <div className="space-y-3">
          ...
          <Card className="p-4 border-l-4 border-l-[#14B8A6] bg-[#14B8A6]/5">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-mono text-primary">INV-003</span>
                ...
                <p className="text-sm text-muted-foreground">Nov 8, 2025</p>
              </div>
          ...
          <Card className="p-4 border-l-4 border-l-[#F59E0B] bg-[#F59E0B]/5">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-mono text-primary">INV-002</span>
          ...
          <Card className="p-4 border-l-4 border-l-[#14B8A6] bg-[#14B8A6]/5">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-mono text-primary">INV-001</span>
                  <Badge className="bg-[#14B8A6] hover:bg-[#14B8A6]/90 flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3" />
                    Paid
                  </Badge>
                ...
                <p className="text-sm text-muted-foreground">Nov 1, 2025</p>
              </div>
              <div className="text-right">
