    ...
    <div className="w-[390px] h-[844px] bg-background flex flex-col">
      ...
      <div className="bg-gradient-to-br from-[#1E3A8A] to-[#14B8A6] text-white p-6 shadow-lg">
        <div className="text-center mb-4">
          ...
          <h1 className="text-2xl font-bold mb-1">My Design Business</h1>
        </div>
        ...
        <Card className="bg-white/10 backdrop-blur border-white/20 p-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-3xl font-mono font-bold">$2,500.00</span>
          </div>
        </Card>
      </div>
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        ...
        <Card className="p-4 space-y-4">
          ...
          <div>
            <label className="text-sm mb-1.5 block">Billing ZIP Code</label>
            <Input 
              placeholder="12345"
              className="bg-input-background"
            />
        ...
        <Card className="p-4 bg-muted/50">
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono">$87.50</span>
            </div>
            <div className="flex justify-between pt-2 border-t border-border">
              <span className="font-medium">Total Charge</span>
              <span className="font-mono font-bold text-primary">$2,587.50</span>
            </div>
          </div>
        </Card>
