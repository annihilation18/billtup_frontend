...
export function ReceiptMockup() {
  return (
    <div className="w-[390px] h-[844px] bg-gradient-to-br from-[#0F172A] to-[#1E3A8A] flex flex-col items-center justify-center p-6">
      ...
      {/* Success Message */}
      <h1 className="text-white text-3xl text-center mb-2">Payment Successful!</h1>
      ...
      <Card className="w-full max-w-md p-6 bg-white/95 backdrop-blur-sm mb-8">
        <div className="space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            ...
            <span className="text-2xl font-mono text-[#14B8A6]">$1,250.00</span>
          </div>
          ...
          <div className="pt-3 border-t border-border">
            <label className="text-sm mb-2 block">Send receipt to customer</label>
