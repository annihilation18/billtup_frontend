    ...
    <div className="w-[390px] h-[844px] bg-background flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4 pb-20">
        ...
        <Card className="p-4">
          ...
          <Button variant="ghost" className="w-full mt-2 text-[#14B8A6]">
        ...
        <Card className="p-4 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-sm mb-1.5 block">Invoice #</label>
              <Input value="INV-004" className="bg-input-background" />
            </div>
            <div>
              <label className="text-sm mb-1.5 block">Date</label>
              <Input type="date" value="2025-11-11" className="bg-input-background" />
            </div>
          </div>
          <div>
            <label className="text-sm mb-1.5 block">Due Date (Optional)</label>
              ...
              <div className="flex-1 pr-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    <Input value="1" className="bg-input-background" />
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground">Rate</label>
                    <Input value="2500.00" className="bg-input-background" />
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground">Amount</label>
                    <Input value="2500.00" disabled className="bg-muted" />
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1 pr-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground">Rate</label>
                    <Input value="750.00" className="bg-input-background" />
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground">Amount</label>
                    <Input value="750.00" disabled className="bg-muted" />
                  </div>
                </div>
              </div>
              <Button variant="ghost" size="icon" className="text-destructive hover:bg-destructive/10">
        ...
        <Card className="p-4 bg-muted/50">
          <div className="space-y-2">
            ...
            <div className="flex justify-between pt-2 border-t border-border">
              ...
              <span className="text-xl font-mono text-primary">$3,526.25</span>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Add your signature to the invoice</p>
            </div>
