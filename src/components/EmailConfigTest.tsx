  ...
  const checkConfig = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-dce439b6/email/check-config`,
        {
          headers: {
      ...
      <Card className="w-full max-w-2xl p-8">
            ...
            {result.smtpStatus?.includes("✅") && (
              <div className="border border-green-200 bg-green-50 rounded-lg p-4">
                ...
                <p className="text-sm text-green-800">
                  ...
                  reset system should work. Check the server logs in Supabase
                  Edge Functions to see detailed email sending information.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm">
          ...
          <ol className="text-blue-800 space-y-1 ml-5 list-decimal">
            ...
            <li>Click on "server" function</li>
            <li>Go to "Logs" tab</li>
