      ...
      <div className="max-w-4xl mx-auto p-4 space-y-4">
        ...
        <Card className="p-4 space-y-4">
          <div className="space-y-2">
            ...
            <Select value={selectedCustomer === "_add_new" ? "_add_new" : selectedCustomer} onValueChange={handleCustomerSelect}>
              <SelectTrigger>
          ...
          {selectedCustomer === "_add_new" && (
            <>
              ...
              <div className="space-y-2">
                <Label htmlFor="newCustomerEmail">Customer Email * <span className="text-xs text-muted-foreground">(Invoice auto-emailed when paid)</span></Label>
                <Input
                  id="newCustomerEmail"
                  type="email"
          ...
          {selectedCustomer && selectedCustomer !== "_add_new" && (
            <>
              <div className="space-y-2">
                <Label htmlFor="customerEmail">Customer Email * <span className="text-xs text-muted-foreground">(Invoice auto-emailed when paid)</span></Label>
                <Input
                  id="customerEmail"
                  type="email"
                  placeholder="customer@example.com"
